...
const routeTemplate = `// Code generated by {{ .ExeName }} tool. DO NOT EDIT.
...
func writeRouters(routers map[string][]Route) error {
	...
	if !libs.IsDirExist(filepath.Dir(routerPath)) {
		if err = os.MkdirAll(filepath.Dir(routerPath), os.ModePerm); err != nil {
